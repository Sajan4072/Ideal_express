    ...
    return (
        <div>
            <div className='flex justify-between my-2 pb-2'>
                <p className='  text-xl font-bold'>Create Shipment</p>
                <IoIosCreate size={25} />
            </div>
            <Form></Form>
    ...
    return (
        ...
        <form>
            ...
            <div className='mt-3 shadow-lg p-3 my-4 flex flex-row-reverse gap-2'>
                <button className='bg-gray-600 hover:bg-gray-800 text-white rounded-md py-1 px-2'>Save as Draft</button>
                <button className='bg-gray-600 hover:bg-gray-800 text-white rounded-md py-1 px-3'>Save</button>
            </div>
        </form>
